(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('Uploader', ['UploaderWithAjax', 'UploaderWithIframe'], factory);
  } else if (typeof module === 'object' && module.exports) {
    module.exports = factory(require(['UploaderWithAjax', 'UploaderWithIframe']));
  } else {
    root.Uploader = factory(root.UploaderWithAjax, root.UploaderWithIframe);
  }
}(this, function(UploaderWithAjax, UploaderWithIframe) {
